...
% 日本語情報（必要なら）
\jclass	{卒業論文}							% 論文種別
\jtitle		{睡眠中の夢は外的刺激により操作できるのか？\\スマートフォンアプリMemoryDreamの\\提案と検証}			% タイトル。改行する場合は\\を入れる
...
\etitle		{MemoryDream iOS App to \\ dream about your desired memory}	% タイトル。改行する場合は\\を入れる
