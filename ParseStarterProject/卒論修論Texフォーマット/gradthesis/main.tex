...
% 日本語情報（必要なら）
\jclass	{卒業論文}							% 論文種別
\jtitle		{DreamDate：レム睡眠時における音刺激の提示を\\用いた夢制御システム}			% タイトル。改行する場合は\\を入れる
...
\etitle		{DreamDate: Dream control system\\ using sound stimuli during REM sleep}	% タイトル。改行する場合は\\を入れる
